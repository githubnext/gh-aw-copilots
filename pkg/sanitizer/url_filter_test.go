...
func TestFilterURLs(t *testing.T) {
	tests := []struct {
		...
		{
			name:                "HTTPS URL with no domain restrictions - defaults to GitHub domains",
			content:             "Check out https://example.com for more info.",
			config:              nil,
			expectedContent:     "Check out [filtered] for more info.",
			expectedRemovedURLs: []string{"https://example.com"},
		},
		{
			name:                "GitHub domain allowed by default",
			content:             "Check out https://github.com for code.",
			config:              nil,
			expectedContent:     "Check out https://github.com for code.",
			expectedRemovedURLs: nil,
		},
		{
			name:                "GitHub.io domain allowed by default",
			content:             "Visit https://example.github.io for docs.",
			config:              nil,
			expectedContent:     "Visit https://example.github.io for docs.",
			expectedRemovedURLs: nil,
		},
		{
			name:                "GitHub API subdomain allowed by default",
		...
		{
			name:                "empty allowed domains list - defaults to GitHub domains",
...
func TestShouldFilterURL(t *testing.T) {
	tests := []struct {
		...
		{
			name:         "HTTPS URL with no restrictions - defaults to GitHub domains",
			rawURL:       "https://example.com",
			config:       nil,
			shouldFilter: true,
		},
		{
			name:         "GitHub.com allowed by default",
			rawURL:       "https://github.com",
			config:       nil,
			shouldFilter: false,
		},
		{
			name:         "GitHub API allowed by default",
			rawURL:       "https://api.github.com",
			config:       nil,
			shouldFilter: false,
		},
		{
			name:         "GitHub.io allowed by default",
			rawURL:       "https://example.github.io",
			config:       nil,
			shouldFilter: false,
		},
		{
...
func TestGenerateJavaScriptURLFilter(t *testing.T) {
	tests := []struct {
		...
		{
			name:         "empty domains - defaults to GitHub domains",
			allowDomains: []string{},
			shouldContain: []string{
				"function filterURLs(content, allowDomains)",
