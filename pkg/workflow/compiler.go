...
func (c *Compiler) generateSafeOutputsMCPServerSetup(yaml *strings.Builder, safeOutputs *SafeOutputsConfig) {
	yaml.WriteString("      - name: Setup Node.js and TypeScript dependencies\n")
	yaml.WriteString("        run: |\n")
	yaml.WriteString("          set -e\n")
	yaml.WriteString("          echo \"Setting up Node.js with TypeScript execution...\"\n")
	yaml.WriteString("          \n")
	yaml.WriteString("          # Ensure Node.js v24+ is available (GitHub Actions runners already have it)\n")
	yaml.WriteString("          node --version\n")
	yaml.WriteString("          \n")
	yaml.WriteString("          # Install tsx globally for TypeScript execution\n")
	yaml.WriteString("          npm install -g tsx\n")
	yaml.WriteString("          \n")
	yaml.WriteString("          echo \"TypeScript execution environment ready\"\n")
