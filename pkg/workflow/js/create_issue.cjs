async function main() {
  ...
  function stripHtmlTags(/** @type {string} */ text) {
    // Remove HTML tags using regex
    return text.replace(/<[^>]*>/g, '');
  }

  // Check if HTML content should be allowed (default: true for backwards compatibility)
  const allowHTML = process.env.GITHUB_AW_ISSUE_ALLOW_HTML;
  const shouldStripHTML = allowHTML === 'false';
